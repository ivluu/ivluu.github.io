...
$(document).ready(function() {
  ...
  myInfo.innerHTML = "<strong>Name:</strong> Ivan Luu</br><strong>Age: </strong>" + age + "</br><strong>Born in: </strong>Los Angeles, CA</br><strong>Lives in: </strong>Rancho Palos Verdes, CA</br><strong>Ethnicity:</strong> Chinese</br><strong>Nationality:</strong> American</br><strong>Languages:</strong> English, Cantonese, HTML, CSS, JavaScript, C, C++</br>";
});
